        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
               ...
               <div class="typing"><p id="typing"></p></div> 
                ...
                <form id="message-submit" action="<?php echo e(URL::to('/send-message')); ?>" method="post"> 
                   <div class="input-group">
             
                    <input type="hidden" name="_token"id="token-message"value="<?php echo e(csrf_token()); ?>">
...
<script> 
 ...
 function ajaxCall() {
    ...
    var oldscrollHeight = $("#scrolltoheight").prop("scrollHeight");
     $.ajax({
         type:'get',
         url:'<?php echo e(URL::to('/chat')); ?>/'+<?php echo $recever;?>,
         datatype:'html',
 ...
 function typinc_receve() {
     ...
     $.ajax({
         type:'get',
         url:'<?php echo e(URL::to('/typing-receve')); ?>/'+<?php echo $recever;?>,
         datatype:'html',
         success:function(response){
                if(response==0){
                  $('#typing').hide('slow');
...
function deleteMessage(id){
    ...
    $.ajax({
        type:'get',
        url:'<?php echo e(URL::to('/deletemessage')); ?>/'+sender,
        datatype:'html'
        });
}
 ...
 var token=$('#token-message').val();
     $.ajax({
             type:'post',
             url:'<?php echo e(URL::to('/send-message')); ?>',
             data:{
                 message:message,
                 recever:<?php echo $recever;?>,
                 sender:<?php echo $id;?>,
